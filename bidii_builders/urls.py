...
urlpatterns = [
    ...
    path(
        "job-materials/create/", views.job_material_create, name="job_material_create"
    ),
    path(
        "job-materials/<int:pk>/", views.job_material_detail, name="job_material_detail"
    ),
    path(
        "job-materials/<int:pk>/edit/",
        views.job_material_update,
        name="job_material_update",
    ),
    path(
        "job-materials/<int:pk>/delete/",
        views.job_material_delete,
        name="job_material_delete",
    ),
    # Invoice CRUD
    ...
    # AJAX endpoints
    path(
        "api/properties/<int:customer_id>/",
        views.load_properties,
        name="load_properties",
    ),
    path(
        "api/create-property/", views.create_property_ajax, name="create_property_ajax"
    ),
    # Jobs schedule (existing)
    path("jobs/schedule/", views.job_schedule, name="job_schedule"),
    path(
        "jobs/<int:job_id>/add-material/",
        views.job_materials_add,
        name="job_materials_add",
    ),
    # Reports and backup
