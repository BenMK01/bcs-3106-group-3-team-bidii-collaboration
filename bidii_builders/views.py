...
def dashboard(request):
    ...
    # Revenue statistics
    total_revenue = (
        Invoice.objects.filter(is_paid=True).aggregate(Sum("amount"))["amount__sum"]
        or 0
    )
    overdue_invoices = Invoice.objects.filter(
        due_date__lt=datetime.now().date(), is_paid=False
    ).count()
...
def customer_dashboard(request):
    ...
    active_jobs = Job.objects.filter(
        estimate__customer=customer, status="in_progress"
    ).count()
    completed_jobs = Job.objects.filter(
        estimate__customer=customer, status="completed"
    ).count()

    # Recent activities for this customer
    recent_estimates = Estimate.objects.filter(customer=customer).order_by(
        "-created_at"
    )[:5]
    recent_jobs = Job.objects.filter(estimate__customer=customer).order_by(
        "-created_at"
    )[:5]
...
def customer_list(request):
    ...
    return render(
        request, "bidii_builders/customers/list.html", {"customers": customers}
    )
    ...
    if request.method == "POST":
        ...
        if request.POST.get("create_user_account"):
            ...
            if not User.objects.filter(username=username).exists():
                ...
                customer.save()
                messages.success(
                    request, f"Customer created with user account: {username}"
                )
            else:
...
def customer_update(request, pk):
    ...
    return render(
        request, "bidii_builders/customers/update.html", {"customer": customer}
    )
...
def customer_delete(request, pk):
    ...
    return render(
        request, "bidii_builders/customers/delete.html", {"customer": customer}
    )
...
def property_list(request):
    ...
    return render(
        request, "bidii_builders/properties/list.html", {"properties": properties}
    )
...
def property_create(request):
    ...
    return render(
        request, "bidii_builders/properties/create.html", {"customers": customers}
    )
...
def property_detail(request, pk):
    ...
    return render(
        request, "bidii_builders/properties/detail.html", {"property": property_obj}
    )
...
def property_update(request, pk):
    ...
    if request.method == "POST":
        property_obj.customer = get_object_or_404(
            Customer, pk=request.POST.get("customer")
        )
    ...
    return render(
        request,
        "bidii_builders/properties/update.html",
        {"property": property_obj, "customers": customers},
    )
...
def property_delete(request, pk):
    ...
    return render(
        request, "bidii_builders/properties/delete.html", {"property": property_obj}
    )
...
def estimate_list(request):
    ...
    return render(
        request, "bidii_builders/estimates/list.html", {"estimates": estimates}
    )
...
def estimate_create(request):
    ...
    if request.method == "POST":
        ...
        if not customer_id or customer_id == "":
            ...
            return render(
                request,
                "bidii_builders/estimates/create.html",
    ...
    if not request.user.is_staff:
        try:
            ...
            if estimate.customer != customer:
                messages.error(
                    request, "You do not have permission to view this estimate."
                )
                return redirect("customer_dashboard")
        except Customer.DoesNotExist:
            messages.error(
                request,
                "You need to be linked to a customer profile to view this estimate.",
            )
            return redirect("login")

    return render(
        request, "bidii_builders/estimates/detail.html", {"estimate": estimate}
    )
...
def estimate_update(request, pk):
    ...
    if request.method == "POST":
        ...
        if not customer_id or customer_id == "":
            ...
            return render(
                request,
                "bidii_builders/estimates/update.html",
                {
                    "estimate": estimate,
                    "customers": customers,
                    "properties": properties,
    ...
    return render(
        request,
        "bidii_builders/estimates/update.html",
        {"estimate": estimate, "customers": customers, "properties": properties},
    )
...
def estimate_delete(request, pk):
    ...
    return render(
        request, "bidii_builders/estimates/delete.html", {"estimate": estimate}
    )
...
def job_detail(request, pk):
    ...
    if not request.user.is_staff:
        try:
            ...
            messages.error(
                request, "You need to be linked to a customer profile to view this job."
            )
            return redirect("login")
    ...
    context = {"job": job, "materials": materials, "invoice": invoice}
...
def job_update(request, pk):
    ...
    return render(
        request, "bidii_builders/jobs/update.html", {"job": job, "estimates": estimates}
    )
...
def material_list(request):
    ...
    return render(
        request, "bidii_builders/materials/list.html", {"materials": materials}
    )
...
def material_detail(request, pk):
    ...
    return render(
        request, "bidii_builders/materials/detail.html", {"material": material}
    )
...
def material_update(request, pk):
    ...
    return render(
        request, "bidii_builders/materials/update.html", {"material": material}
    )
...
def material_delete(request, pk):
    ...
    return render(
        request, "bidii_builders/materials/delete.html", {"material": material}
    )
...
def job_material_list(request):
    ...
    return render(
        request,
        "bidii_builders/job_materials/list.html",
...
def job_material_create(request):
    ...
    return render(
        request,
        "bidii_builders/job_materials/create.html",
        {"jobs": jobs, "materials": materials},
    )
...
def job_material_detail(request, pk):
    ...
    return render(
        request,
        "bidii_builders/job_materials/detail.html",
...
def job_material_update(request, pk):
    ...
    if request.method == "POST":
        ...
        job_material.material = get_object_or_404(
            Material, pk=request.POST.get("material")
        )
    ...
    return render(
        request,
        "bidii_builders/job_materials/update.html",
        {"job_material": job_material, "jobs": jobs, "materials": materials},
    )
...
def job_material_delete(request, pk):
    ...
    return render(
        request,
        "bidii_builders/job_materials/delete.html",
        {"job_material": job_material},
    )
...
def invoice_create(request, job_id=None):
    ...
    jobs = Job.objects.filter(
        status="completed"
    )  # Only completed jobs can have invoices
    ...
    return render(
        request, "bidii_builders/invoices/create.html", {"jobs": jobs, "job": job}
    )
    ...
    if not request.user.is_staff:
        try:
            ...
            if invoice.job.estimate.customer != customer:
                messages.error(
                    request, "You do not have permission to view this invoice."
                )
                return redirect("customer_dashboard")
        except Customer.DoesNotExist:
            messages.error(
                request,
                "You need to be linked to a customer profile to view this invoice.",
            )
            return redirect("login")
...
def invoice_update(request, pk):
    ...
    return render(
        request,
        "bidii_builders/invoices/update.html",
...
def payment_create(request):
    ...
    invoices = Invoice.objects.filter(
        is_paid=False
    )  # Only unpaid invoices can receive payments
    ...
    return render(
        request, "bidii_builders/payments/create.html", {"invoices": invoices}
    )
...
def payment_update(request, pk):
    ...
    return render(
        request,
        "bidii_builders/payments/update.html",
        {"payment": payment, "invoices": invoices},
    )
...
def load_properties(request, customer_id):
    ...
    properties = Property.objects.filter(customer_id=customer_id).values(
        "id", "address"
    )
    ...
    if request.method == "POST":
        try:
            ...
            if not customer_id or not address:
                return JsonResponse(
                    {"success": False, "error": "Customer ID and address are required"}
                )

            customer = get_object_or_404(Customer, pk=int(customer_id))
            property_obj = Property.objects.create(
                customer=customer, address=address, property_type=property_type
            )
...
def job_schedule(request):
    ...
    if request.method == "POST":
        estimate = get_object_or_404(
            Estimate, pk=request.POST.get("estimate_id"), status="accepted"
        )
    ...
    return render(
        request, "bidii_builders/jobs/schedule.html", {"estimates": accepted_estimates}
    )
...
def job_materials_add(request, job_id):
    ...
    return render(
        request,
        "bidii_builders/job_materials/add.html",
...
def dashboard_charts_data(request):
    ...
    for i in range(12):
        month = (
            datetime.now().date().replace(month=i + 1)
            if i + 1 <= datetime.now().month
            else datetime.now()
            .date()
            .replace(year=datetime.now().year - 1, month=i + 1)
        )
        revenue = (
            Invoice.objects.filter(
                issue_date__month=month.month, issue_date__year=month.year, is_paid=True
            ).aggregate(Sum("amount"))["amount__sum"]
            or 0
        )
        revenue_data.append({"month": month.strftime("%B"), "revenue": float(revenue)})
    ...
    data = {"revenue_data": revenue_data, "job_status_data": job_status_data}
...
def reports(request):
    ...
    for i in range(12):
        month = (
            datetime.now().replace(month=i + 1)
            if i + 1 <= datetime.now().month
            else datetime.now().replace(year=datetime.now().year - 1, month=i + 1)
        )
        revenue = (
            Invoice.objects.filter(
                issue_date__month=month.month, issue_date__year=month.year, is_paid=True
    ...
    context = {
        ...
        "total_revenue": Invoice.objects.filter(is_paid=True).aggregate(Sum("amount"))[
            "amount__sum"
        ]
        or 0,
    }
...
def customer_invoices(request):
    ...
    invoices = Invoice.objects.filter(job__estimate__customer=customer).order_by(
        "-issue_date"
    )
